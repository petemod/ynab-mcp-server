...
import { z } from "zod";
class GetTransactionsByPayeeTool extends MCPTool {
    ...
    schema = {
        ...
        lastKnowledgeOfServer: {
            ...
            description: "If provided, only transactions changed since this server knowledge will be returned",
        },
    };
    api;
    budgetId;
    ...
    async execute(input) {
        ...
        try {
            ...
            logger.error(`Error fetching transactions for payee ${input.payeeId} in budget ${budgetId}:`);
